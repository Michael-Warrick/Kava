...
Graphics::ImageView::ImageView(const vk::Device &logicalDevice,
...
vk::ImageView Graphics::ImageView::get() const { return m_ImageView; }

void Graphics::ImageView::createImageView(
    const vk::Image image, const vk::Format format,
    ...
    vk::Result result =
        m_LogicalDevice.createImageView(&viewInfo, nullptr, &m_ImageView);
